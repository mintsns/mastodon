...
import GplusScrollableList from './gplus_scrollable_list';
...
export default class GplusStatusList extends ImmutablePureComponent {
  ...
  render () {
    ...
    return (
      <GplusScrollableList {...other} onLoadMore={onLoadMore && this.handleLoadOlder} shouldUpdateScroll={shouldUpdateScroll} ref={this.setRef}>
        {scrollableContent}
      </GplusScrollableList>
    );
  }

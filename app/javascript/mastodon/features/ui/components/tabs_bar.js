...
export const links = [
  ...
  <NavLink className='tabs-bar__link secondary' to='/timelines/public/gplus' data-preview-title-id='column.gplus_community' data-preview-icon='users' ><i className='fa fa-fw fa-users' /><FormattedMessage id='tabs_bar.gplus_local_timeline' defaultMessage='G+ LTL' /></NavLink>,
